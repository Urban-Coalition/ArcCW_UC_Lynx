...
SWEP.DistantShootSoundIndoors = {
	tail .. "fire-dist-300blk-rif-int-01.ogg",
	tail .. "fire-dist-300blk-rif-int-02.ogg",
	tail .. "fire-dist-300blk-rif-int-03.ogg",
	tail .. "fire-dist-300blk-rif-int-04.ogg",
	tail .. "fire-dist-300blk-rif-int-05.ogg",
	tail .. "fire-dist-300blk-rif-int-06.ogg"
}
...
SWEP.Animations = {
	...
	["reload"] = {
		...
		SoundTable = {
			...
			{s = common .. "magpouch.ogg",			t = 0.45, v = 0.4},
	...
	["reload_empty"] = {
		...
		SoundTable = {
			...
			{s = common .. "magpouch.ogg",			t = 0.5, v = 0.4 },
			{s = common .. "rifle_magdrop.ogg",  t = 0.75, v = 0.75},
		...
		["reload_100"] = {
			...
			SoundTable = {
				...
				{s = common .. "magpouch.ogg",			t = 1.1, v = 0.4 },
		...
		["reload_empty_100"] = {
			...
			SoundTable = {
				...
				{s = common .. "magpouch.ogg",			t = 0.9, v = 0.4 },
	...
	["reload_40"] = {
		...
		SoundTable = {
			...
			{s = common .. "magpouch.ogg",			t = 0.6, v = 0.4 },
	...
	["reload_empty_40"] = {
		...
		SoundTable = {
			...
			{s = ratel,								t = 0.05},
			{s = path .. "magout.ogg",				t = 0.2 },
			{s = common .. "magpouch.ogg",			t = 0.7, v = 0.4 },
